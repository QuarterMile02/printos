-- Refresh search_customers_fuzzy so disabled (is_active=false) customers
-- are included in picker search results. Earlier deployments may have had
-- an is_active filter; this version removes it entirely.
