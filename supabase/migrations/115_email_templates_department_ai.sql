...
-- Applied: yes — confirmed live (department exists as scalar text, exactly
-- as this file defines it; ai_personalize exists as boolean). See migration
-- 116 for the follow-up that converts department from scalar to array —
-- do NOT re-run or edit this file, it matches what's actually in production.
-- ============================================================
--
-- Adds:
