...
export default function QuoteDetailClient({
  ...
  // Auto-calculate price when product, dimensions, or quantity change
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      fetch('/api/pricing', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ product_id: newProductId, width_inches: w, height_inches: h, quantity: q, selected_modifiers: newModifierValues }),
      })
        .then(res => res.json())
        .then(data => {
          if (cancelled) return
          ...
          <div>
            ...
            <div className="mt-2">
              <QuoteCustomerPicker
                ...
                initialContactPhone={initialContactPhone ?? null}
                initialContactEmail={initialContactEmail ?? null}
