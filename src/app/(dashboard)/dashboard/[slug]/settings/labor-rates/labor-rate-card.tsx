...
export function LaborRateCard({ rate, orgSlug, deptLabel }: { rate: LaborRateCardRow; orgSlug: string; deptLabel: string | null }) {
  const href = `/dashboard/${orgSlug}/settings/labor-rates?edit=${rate.id}`
