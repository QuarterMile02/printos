...
import type { ProductTypeRow } from './product-types-list-client'

export function ProductTypeCard({ type, orgSlug, count }: { type: ProductTypeRow; orgSlug: string; count: number }) {
  const href = `/dashboard/${orgSlug}/settings/product-types?edit=${type.id}`
