...
export default async function MachineRatesImportPage(props: PageProps) {
  try {
    ...
    console.error('[machine-rates-import] page crash:', err)
    return (
      <div style={{ padding: '2rem', color: '#b91c1c', fontFamily: 'monospace', whiteSpace: 'pre-wrap' }}>
        <h1 style={{ fontSize: '1.5rem', fontWeight: 'bold', marginBottom: '1rem' }}>PAGE ERROR (machine-rates-import)</h1>
